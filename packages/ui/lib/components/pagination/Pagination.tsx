...
export const Pagination = ({
  ...
  return (
    <div
      className={cn(
        'flex items-center justify-between border-t border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-700 dark:bg-gray-800',
        className,
      )}>
      {/* Mobile pagination */}
            ...
            {visiblePages.map((page, index) => (
              <button
                ...
                className={cn(
                  ...
                  page === currentPage
                    ? 'z-10 border-blue-500 bg-blue-50 text-blue-600 dark:border-blue-400 dark:bg-blue-900 dark:text-blue-300'
