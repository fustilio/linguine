...
import { cn, ErrorDisplay, LoadingSpinner, useURLParam } from '@extension/ui';
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="space-y-4">
                      <div>
                        <label htmlFor="nativeLanguage" className="mb-2 block text-sm font-medium">
                          Native Language
                        </label>
                        <select
                          id="nativeLanguage"
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {/* Shared Context */}
                      <div>
                        <label htmlFor="sharedContext" className="mb-2 block text-sm font-medium">
